...
<html lang="en">
    ...
    <head>
        <title>Registro Pacientes - Neumovida</title>
                                    ...
                                    <div class="page-wrapper">
                                        ...
                                        <div class="page-header">
                                            <div class="page-header-title">
                                                <h4>Registro</h4>
                                                <span>Esta es una seccion exclusiva para los pacientes de Neumovida, si no eres un paciente no podras realizar acabo la totalidad del regisro.</span>
                                            </div>
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Registro de Pacientes</a>
                                                    </li>
                                                        ...
                                                        <div class="card-block">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div id="wizard-3">
                                                                        <section>
                                                                            <form class="wizard-form" id="form-registro-paciente" action="#">
                                                                                ...
                                                                                <h3> Finalizar </h3>
                                                                                <fieldset>
                                                                                    Formulario completado, presiona finalizar para crear tu usuario.                                                                                    
                                                                                </fieldset>
                                                                            </form>
    ...
    <![endif]-->
        ...
        <!--<script src="<?=base_url()?>assets/plantillas/mash_able/pages/forms-wizard-validation/form-wizard.js"></script>-->
        <script src="<?=base_url()?>assets/neumovida/js/registro/pacientes.js"></script>
